...
public class CatalogRepositoryArchitectureRule {
	...
	@ArchTest
	public static final ArchRule repository_classes_should_be_in_repository_impl_package = 
		    classes()
	...
	@ArchTest
	public static final ArchRule repository_classes_should_have_names_ending_with_the_word_repository_impl = 
		    classes()
	...
	@ArchTest
	public static final ArchRule repository_classes_classes_should_be_public = 
		    classes()
		    .that().resideInAPackage(ArchUnitPackageConstant.RESIDE_FINAL_PACKAGE_REPOSITORY_IMPL_CLASS)
		    .should().bePublic();
	
	@ArchTest
	public static final ArchRule no_repository_classes_should_be_reside_other_packages = 
			noClasses()
			.that().haveSimpleNameEndingWith(ArchUnitNameConstant.SUFFIX_NAME_REPOSITORY_IMPL_CLASS)
