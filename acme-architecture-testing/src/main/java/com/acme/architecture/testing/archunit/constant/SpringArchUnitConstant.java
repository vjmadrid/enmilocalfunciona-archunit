...
public final class SpringArchUnitConstant {
	...
	public static final String SUFFIX_NAME_SPRING_REPOSITORY_CLASS = ArchUnitConstant.SUFFIX_NAME_REPOSITORY_CLASS;
	public static final String SUFFIX_NAME_SPRING_SERVICE_CLASS = ArchUnitConstant.SUFFIX_NAME_SERVICE_CLASS;
...
//	public static final String SUFFIX_NAME_SPRING_APPLICATION_CLASS = "Application";
	...
	public static final String RESIDE_FINAL_PACKAGE_SPRING_REPOSITORY_CLASS = ArchUnitConstant.RESIDE_FINAL_PACKAGE_REPOSITORY_CLASS;
	public static final String RESIDE_FINAL_PACKAGE_SPRING_SERVICE_CLASS = ArchUnitConstant.RESIDE_FINAL_PACKAGE_SERVICE_CLASS;
...
//	public static final String RESIDE_FINAL_PACKAGE_SPRING_APPLICATION_CLASS = "..app";
	...
	public static final String RESIDE_PACKAGE_SPRING_REPOSITORY_CLASS = RESIDE_FINAL_PACKAGE_SPRING_REPOSITORY_CLASS+ArchUnitConstant.PACKAGE_INCLUDE;
	public static final String RESIDE_PACKAGE_SPRING_SERVICE_CLASS = RESIDE_FINAL_PACKAGE_SPRING_SERVICE_CLASS+ArchUnitConstant.PACKAGE_INCLUDE;
	public static final String RESIDE_PACKAGE_SPRING_IMPL_SERVICE_CLASS = RESIDE_FINAL_PACKAGE_SPRING_IMPL_SERVICE_CLASS+ArchUnitConstant.PACKAGE_INCLUDE;
	public static final String RESIDE_PACKAGE_SPRING_REST_CONTROLLER_CLASS = RESIDE_FINAL_PACKAGE_SPRING_REST_CONTROLLER_CLASS+ArchUnitConstant.PACKAGE_INCLUDE;
...
//	public static final String RESIDE_PACKAGE_SPRING_APPLICATION_CLASS = RESIDE_FINAL_PACKAGE_SPRING_APPLICATION_CLASS+ArchUnitConstant.PACKAGE_INCLUDE;
	public static final String RESIDE_PACKAGE_SPRING_CONFIG_CLASS = RESIDE_FINAL_PACKAGE_SPRING_CONFIG_CLASS+ArchUnitConstant.PACKAGE_INCLUDE;
//	
