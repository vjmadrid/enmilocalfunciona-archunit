package com.acme.example.archunit.core.importclasses.component.util;
...
public class ArchUnitComponentUtil {
	
	protected ArchUnitComponentUtil() {
		throw new IllegalStateException("ArchUnitComponentUtil");
	}
